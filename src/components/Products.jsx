...
const Products = () => {
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold text-[#202224]">Products</h2>
      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#4880FF] p-8 md:p-16 text-white min-h-[300px] flex flex-col justify-center">
        ...
        <div className="relative z-10 max-w-lg">
          <p className="text-sm font-medium opacity-90 mb-2">September 12-22</p>
          ...
          <button className="bg-[#FF8743] hover:bg-[#e67635] text-white px-8 py-3 rounded-xl font-bold transition-colors">
            Get Started
          </button>
        </div>
...
const ProductCard = ({ product }) => {
  return (
    <div className="bg-white rounded-[24px] p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow group">
      {/* Image Container with Slider UI */}
      ...
      <div className="space-y-2">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-[#4880FF] font-bold">${product.price.toFixed(2)}</p>
          </div>
